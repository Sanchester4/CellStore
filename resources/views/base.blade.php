...
<link href="https://cdn.jsdelivr.net/npm/bootstrap@5.2.2/dist/css/bootstrap.min.css" rel="stylesheet" integrity="sha384-Zenh87qX5JnK2Jl0vWa8Ck2rdkQ2Bzep5IDxbcnCeuOxjzrPF/et3URy9Bv1WTRi" crossorigin="anonymous">
    ...
    <nav class="navbar">
        <div class="navbar__container">
          ...
          <ul class="navbar__menu">
            ...
            <li class="navbar_item">
              <a href="{{ route('getCart')}}" class="navbar__links" id="cart-page" style="margin-top:-15px;"
                ><i class="fa fa-store"></i> Cart</a
              >
            </li>
            @if (Auth::guest())
            <li class="navbar_btn">
                <a href="{{ route('login') }}" class="button" id="signin-page"  style="margin-top:-16px;"
                  >Login</a>
              </li>
        @else
            {{-- {{ Auth::user()->name }} --}}
        ...
        <footer id="footer" class="footer-1">
          ...
          <h5 class="widget-title">CELLSTORE<span></span></h5>
          <p>Our site provides help in choosing a brand new phone at accessible price.</p>
          </div>
          </div>
          ...
          <li>
          <div class="thumb-content"><a href="#.">Main Page</a></div> 
          </li>
          <li>
          <div class="thumb-content"><a href="#.">Shop</a></div> 
          </li>
          <li>
          <div class="thumb-content"><a href="#.">Cart</a></div> 
          </li>
          <li>
          <div class="thumb-content"><a href="#.">Wish List</a></div> 
          </li>
          <li>
          ...
          <div class="col-xs-12 col-sm-6 col-md-3">
          <div class="widget no-box">
          <h5 class="widget-title">Discounts<span></span></h5>
          <p>Get a personal discount by answering correct at 5 Tech questions</p>
          <a class="btn" href="https://bit.ly/3m9avif" target="_blank">Get Discount!</a>
          </div>
          </div>
          ...
          <p><a href="mailto:info@domain.com" title="glorythemes" style="color: white;">info@domain.com</a></p>
          ...
          <p>Copyright CellStore SRL Craiova © 2022. All rights reserved.</p>
          </div>
          </div>
          </div>
          </div>
